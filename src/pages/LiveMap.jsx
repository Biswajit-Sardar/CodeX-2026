...
export default function LiveMap() {
  ...
  return (
    <div className="page-enter">
      ...
      {/* map-toolbar ও search container-এ z-index ও relative পজিশন দেওয়া হয়েছে */}
      <div className="map-toolbar" style={{ position: 'relative', zIndex: 1001 }}>
        <div className="map-toolbar__search" style={{ position: 'relative', zIndex: 1002 }}>
          <div className="dashboard-search__label">Jump to an area</div>
          <AreaSearch
            placeholder="Search a locality, city, landmark…"
            onSelect={(place) => setSearchedPlace(place)}
      ...
      {/* ম্যাপ প্যানেলের z-index 1 রাখা হয়েছে যাতে টুলবারের ড্রপডাউন উপরে থাকে */}
      <div className="panel map-panel" style={{ position: 'relative', zIndex: 1 }}>
        <MapContainer center={position || KGP_CENTER} zoom={13} style={{ height: 480, width: '100%' }}>
          <TileLayer
            attribution='&copy; OpenStreetMap contributors'
            url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
